...
<title>Mis Pedidos x Seguimiento</title>
</head>
<body>
	<!-- ------------------------------------------------------------------------------------------------------------------ -->
	<header>
		<h1>Mis Pedidos Ordenado por Codigo de Seguimiento</h1>
	</header>
	<!-- ------------------------------------------------------------------------------------------------------------------ -->
	<nav>
			<%
	...
	<div id="contenedor">
		<table id="target">
			...
			listaEnvios = service.traerAllMisPedidos(dniUsuario,"codSeguimiento");
