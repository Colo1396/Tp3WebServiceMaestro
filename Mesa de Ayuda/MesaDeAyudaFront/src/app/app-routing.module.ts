...
const routes: Routes = [
  ...
  { path: 'denuncias', component: CreateDenunciaComponent, canActivate: [AuthGuard] },
  { path: 'denunciasList', component: DenunciaListComponent, canActivate: [AuthGuard] },
  { path: 'reclamos', component: CreateReclamoComponent, canActivate: [AuthGuard] },
  { path: 'reclamosList', component: ReclamoListComponent, canActivate: [AuthGuard] }
