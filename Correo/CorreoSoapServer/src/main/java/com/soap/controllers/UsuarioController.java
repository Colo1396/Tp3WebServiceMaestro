...
public class UsuarioController  extends Conexion  {
	...
	public List<Usuario> findAll() throws SQLException {
		try {
			String sql = "SELECT idUsuario,razonSocial,idUsuarioRef,dni,usuario,contraseña FROM usuario";
	...
	public Usuario findById(int id) throws SQLException {
		try {
			String sql = "SELECT idUsuario,razonSocial,idUsuarioRef,dni,usuario,contraseña FROM usuario WHERE idUsuario = " + id + "";
	...
	public boolean create(Usuario usuario) throws SQLException {
		try {
			String sql = "INSERT INTO usuario (idUsuario,razonSocial,idUsuarioRef,dni,usuario,contraseña) VALUES(null, ?, ?,?,?,?)";
	...
	public boolean update(Usuario usuario) throws SQLException {
		try {
			String sql = "UPDATE usuario SET razonSocial = ?, idUsuarioRef = ?,dni=?,usuario=?,contraseña=? WHERE idUsuario = ?";
	...
	public Usuario findByDni(int dni) throws SQLException {
		try {
			String sql = "SELECT idUsuario,razonSocial,idUsuarioRef,dni,usuario,contraseña FROM usuario WHERE dni = " + dni + "";
