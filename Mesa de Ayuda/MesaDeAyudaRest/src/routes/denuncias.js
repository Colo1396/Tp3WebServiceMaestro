...
const {crearDenuncia,eliminarDenuncia,modificarDenuncia, obtenerDenuncia, obtenerDenunciasPorEstado} = require('../controllers/denunciaController');

//api/denuncias/
//router.get('/', obtenerMediosDePago);
router.get('/:id', verificacionToken ,obtenerDenuncia);
router.get('/', [verificacionToken, esRolMesaDeAyuda], obtenerDenunciasPorEstado);
